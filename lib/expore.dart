  ...
  Widget build(BuildContext context) {
    return  SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        SizedBox(height:30,),// ignore: prefer_const_literals_to_create_immutables
        TextField(
...
SizedBox(width: 10,),
        ...
        height:39 ,
        width:60,
           child:   Center(child: Text('Copy',style: TextStyle(fontSize:22,fontWeight: FontWeight.bold),)),
...
borderRadius: BorderRadius.circular(9),
    ...
    suffixIcon: Icon(Icons.arrow_forward_ios),
         ...
         decoration: BoxDecoration(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(15),
             color:Color.fromARGB(255, 4, 133, 9),
